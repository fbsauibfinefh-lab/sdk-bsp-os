...
class ZephyrBackend(OSBackend):
    ...
    def generate(
        ...
        source.write_text(self._validation_source(), encoding="utf-8")
        ...
        binding_manifest = NativeDriverBindingTracer().generate(
            ir, profile_name, "zephyr", [], provider_roots
        )
        device_manifest = {
            "schema_version": "1.0",
            "created_at": utc_now(),
...
'''
    ...
    def _validation_source() -> str:
        return r'''/* Generated by BSPForge; evidence is stored in bspforge/. */
...
{
    static const char banner[] = "BSPForge Zephyr validation\r\n";
