...
v0.6 已完成源码/头文件混合语法前端、7 SDK 真值语料、固定/学习/融合排序、通用能力绑定计划、目标感知资产选择、风险分级诊断事务和跨 RTOS 自测工具。3 块开发板 × 2 个 RTOS 的六组工程均已完成固件静态验证；Zephyr native_sim 已完成 20 轮可执行回归。实物结果仍需烧录采集，不能由编译或仿真成功替代。
